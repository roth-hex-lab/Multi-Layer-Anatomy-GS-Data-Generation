...
if __name__ == "__main__":
    ...
    # settings
    OUT_PATH = os.path.join(ROOT_DIR, 'generated/leg-gen/muscle-v1_cut_lowerhalf')
    ...
    CLIP_MAX = volpy.vec3(1, 1, 0) # Setting max to lower than min makes the lower part visible
