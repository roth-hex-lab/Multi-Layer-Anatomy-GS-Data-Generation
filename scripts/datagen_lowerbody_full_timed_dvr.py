...
if __name__ == "__main__":
    ...
    EXPOSURE = 1.9  # Instead of default 5
    GAMMA = 1.7     # Instead of default 2.2  
    SAMPLES = 1
    BOUNCES = 0
    ENV_STRENGTH = 0

    # settings
    OUT_PATH = os.path.join(ROOT_DIR, f'generated/lowerbody-gen-timed/full-{SAMPLES}s-{BOUNCES}b-{RUNS}r')
    ...
    renderer.tonemap_exposure = EXPOSURE
    renderer.tonemap_gamma = GAMMA
